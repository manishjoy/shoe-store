    ...
    public function createPostAction()
    {
        ...
        try {
            ...
            if ($e->getCode() === Mage_Customer_Model_Customer::EXCEPTION_EMAIL_EXISTS) {
                ...
                $message = $this->__('There is already an account with this email address or phone number. If you are sure that it is your email address, <a href="%s">click here</a> to get your password and access your account.', $url);
            } else {
